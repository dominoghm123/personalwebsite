# 🛠️ Web Vibe Coding 系统化工程最佳实践 V0.1


> **适用范围**：风格化个人网站（Project / Post / Footprint / About,etc）
> **推荐技术栈**：见下方技术栈选型
...
4. 盘点现有内容资产（Project、Post、Footprint、About 等）
...
| **Could Have** | 锦上添花 | Footprint 地图动画、阅读进度条 |
...
规定 Project / Post / Footprint / About 的标准字段格式。**这是防止数据混乱的关键契约。**
...
- [ ] Footprint 地图（Leaflet / MapLibre GL）
- [ ] 暗色模式切换
- [ ] 页面过渡动画
